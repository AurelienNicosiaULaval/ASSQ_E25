...
1.  Vous offrir un **résumé clair et pratique** des avancées des deux
    dernières années en lien avec R.
...
-   Relisez et tester toujours le code généré par l’IA avant de
    committer.
